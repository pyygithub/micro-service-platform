...
public enum ResponseCode {
    ...
    VALIDATE_CODE_IS_BLANK(20006, "验证码的值不能为空"),
    VALIDATE_CODE_NO_VALID(20007, "验证码无效"),
    VALIDATE_CODE_ERROR(20008, "验证码错误"),
    VALIDATE_CODE_EXPIRED(20009, "验证码已过期"),
    VALIDATE_CODE_REQ_ERROR(20010, "获取验证码值失败"),
    VALIDATE_CODE_NOT_EXISTS(20011, "验证码不存在"),
